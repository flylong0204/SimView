...
BEGIN_MESSAGE_MAP(CMainUIApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CMainUIApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CMainUIApp::CMainUIApp()
{
	...
	SetAppID(_T("MainUI.AppID.NoVersion"));
...
// CMainUIApp 自定义加载/保存方法

void CMainUIApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMainUIApp::LoadCustomState()
{
}

void CMainUIApp::SaveCustomState()
{
}
